...
# img_list = os.listdir(os.path.join(rootfolder, 'image'))
#
# import random
# import shutil
# rand_list = random.sample(img_list, int(len(img_list)*0.9))
# for i in rand_list:
#     shutil.copy(os.path.join(rootfolder, 'image', i), os.path.join(rootfolder, 'train_tr/images', i))
#     shutil.copy(os.path.join(rootfolder, 'txt_label', i).replace('.jpg', '.txt'), os.path.join(rootfolder, 'train_tr/labels', i).replace('.jpg', '.txt'))
#
# for i in img_list:
#     if i not in rand_list:
#         shutil.copy(os.path.join(rootfolder, 'image', i), os.path.join(rootfolder, 'train_val/images', i))
#         shutil.copy(os.path.join(rootfolder, 'txt_label', i).replace('.jpg', '.txt'),
#                     os.path.join(rootfolder, 'train_val/labels', i).replace('.jpg', '.txt'))
#


# image_root = os.path.join(rootfolder, 'train_tr_final/images')
# txt_path = os.path.join(rootfolder, 'train_tr_final/labelTxt')
# dest_file = os.path.join(rootfolder, 'train_tr_final/train.json')

# image_root = os.path.join(rootfolder, 'train_val_split/images')
# txt_path = os.path.join(rootfolder, 'train_val_split/labelTxt')
# dest_file = os.path.join(rootfolder, 'train_val_split/val.json')

# image_root = os.path.join(rootfolder, 'test_split/images')
# dest_file = os.path.join(rootfolder, 'test.json')
